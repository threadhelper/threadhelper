...
export enum IdleMode{random="random", timeline="timeline"}

export enum SearchMode{fulltext="fulltext", semantic="semantic"}

export enum OptionName{name="name", getRTs="getRTs", useBookmarks="useBookmarks", useReplies="useReplies", idleMode="idleMode", roboActive="roboActive", searchMode="searchMode",}
