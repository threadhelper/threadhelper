...
const msg2SampleArgs = (m: { n_tweets: any; filters: any; accsShown: any }) => [
  m.n_tweets,
  m.filters,
  db.get(getDb(1)),
  m.accsShown,
...
const callGetIdleTweets = (m: { idle_mode: string | number }) =>
  pipe(msg2SampleArgs, apply(idleFns[m.idle_mode]))(m);
