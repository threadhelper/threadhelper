...
const configDirs = { BUILD_DIR, PROJ_DIR, HTML_DIR, STYLE_DIR, IMG_DIR, APP_DIR,}
...
function buildConfig(env, argv) {
  if (argv.mode === 'production') {
    ...
    if (['serve', 'webext', 'development'].includes(env.devMode)){
      ...
      console.log(`Wrong webpack build parameter env.devMode="${env.devMode}". Possible choices: 'serve', 'webext', or 'development'.`)
    }
  } 
}
