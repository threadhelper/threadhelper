...
}, "pGKq6I+KUYeLSiMR8kz/mQ+n6/0=") : _hooks_useStorage__WEBPACK_IMPORTED_MODULE_4__["useStorage"]; // function reqSearch(query:string){
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(__prefresh_utils__, module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tweet", function() { return Tweet; });
/* harmony import */ var preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact/jsx-runtime */ "./node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js");
/* harmony import */ var _utils_ga__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/ga */ "./src/ts/utils/ga.tsx");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_wutils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/wutils */ "./src/ts/utils/wutils.tsx");
...
var getTweetUrl = function getTweetUrl(tweet) {
  return "https://twitter.com/".concat(tweet.username, "/status/").concat(tweet.id);
};
...
function Tweet(props) {
  ...
  var id = tweet.id;
  var timeDiff = getTimeDiff(tweet.time);
  var reply_text = "";

  try {
    reply_text = getReplyText(tweet.reply_to, tweet.mentions);
  } catch (e) {
    console.log('ERROR [getReplyText]', {
      e: e,
      tweet: tweet
    });
  }

  var text = reformatText(tweet.text, tweet.reply_to, tweet.mentions, tweet.urls, tweet.media);
  var maybeMedia = tweet.has_media ? renderMedia(tweet.media, "th-media") : "";
  var maybeQuote = tweet.has_quote ? renderQuote(tweet.quote, tweet.has_media) : ""; // let tweetLink = `https://twitter.com/${"undefined"}/status/${tweet.id}`
  // try{
  ...
  var onClick = function onClick(e) {
    Object(_utils_ga__WEBPACK_IMPORTED_MODULE_1__["csEvent"])('User', 'Clicked tweet');
    return onClickTweet(tweet, _utils_wutils__WEBPACK_IMPORTED_MODULE_3__["getActiveComposer"], e);
  };

  return Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
    "class": "th-tweet-container",
    children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
      ...
      children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
        "class": "th-gutter",
        children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("img", {
          "class": "th-profile",
          src: tweet.profile_image
        })
      }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
        "class": "th-body",
        children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
          "class": "th-header",
          children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
            ...
            "class": "th-header-username",
            children: ["@", tweet.username]
          }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
            "class": "th-header-dot",
            children: "\xB7"
          }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
            "class": "th-header-time",
            children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("a", {
              "class": "th-header-time-link",
          ...
          "class": "th-text",
          children: text
        }), maybeMedia, maybeQuote]
      })]
    }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
      "class": "th-hover",
      onClick: onClick,
      children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("textarea", {
        style: "display: none",
        id: "th-link-".concat(tweet.id),
        "class": "th-link",
        children: getTweetUrl(tweet)
      }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
        "class": "th-hover-copy",
        children: "copy"
      }), Object(ramda__WEBPACK_IMPORTED_MODULE_4__["isNil"])(props.score) ? null : Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
        "class": "th-hover-copy",
        children: "\nscore: ".concat(props.score.toFixed(2))
      })]
    })]
  });
}
...
var onClickTweet = function onClickTweet(tweet, getActiveComposer, e) {
  var input = getActiveComposer();
  var link = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#th-link-".concat(tweet.id))[0];
  var copy = jquery__WEBPACK_IMPORTED_MODULE_2___default()(e.target).find(".th-hover-copy");
  ...
  if (input != null) {
    input.focus(); // https://stackoverflow.com/questions/24115860/set-caret-position-at-a-specific-position-in-contenteditable-div
    // There will be multiple spans if multiple lines, so we get the last one to set caret to the end of the last line.

    var _span = jquery__WEBPACK_IMPORTED_MODULE_2___default()(input).find('span[data-text=true]').last()[0]; // If there's some writing on it, otherwise _span will be undefined
...
var shortMonths = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; // function renderTweetLike(tweet, copyContent, onClick){
...
function getTimeDiff(time) {
  var now = new Date();
  var timeDate = new Date(time); // FIXME: The left-hand side of an arithmetic operation must... Remove this comment to see the full error message

  var diff = now.getTime() - timeDate.getTime(); // In milliseconds.
  ...
  var month = shortMonths[timeDate.getMonth()];
  var day = timeDate.getDate();
  var thisYear = new Date(now.getFullYear(), 0);
  return timeDate > thisYear ? "".concat(month, " ").concat(day) : "".concat(month, " ").concat(day, ", ").concat(timeDate.getFullYear());
}
...
function getReplyText(reply_to, mentions) {
  if (reply_to === null) {
    ...
    return "Replying to @".concat(reply_to);
  ...
  var otherWord = numOthers === 1 ? "other" : "others";
  return "Replying to @".concat(reply_to, " and ").concat(numOthers, " ").concat(otherWord);
}
...
function reformatText(text) {
  var reply_to = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

  var _mentions = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

  var urls = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var media = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  var mentions = Object(ramda__WEBPACK_IMPORTED_MODULE_4__["defaultTo"])([], _mentions);
  var ret = text;
  var charsRemoved = 0; // Cut out reply_to + any mentions at the beginning.
  ...
  if (media !== null) {
    var _iterator4 = _createForOfIteratorHelper(media),
        _step4;
...
function renderMedia(media, className) {
  ...
  if (media.length > 0) {
    topImgs.push(Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
      "class": "th-media-image",
      children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("img", {
        src: media[0].url
      })
    }));
  ...
  if (media.length > 2) {
    botImgs.push(Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
      "class": "th-media-image",
      children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("img", {
        src: media[2].url
      })
  ...
  var top = Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
    "class": "th-media-top",
    children: topImgs
  });

  var bottom = botImgs.length <= 0 ? "" : Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
    "class": "th-media-bottom",
    children: botImgs
  });
  return Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
    "class": className,
...
function renderQuote(quote, parent_has_media) {
  if (quote != null) {
    var timeDiff = getTimeDiff(quote.time);
    var replyText = getReplyText(quote.reply_to, quote.mentions);
    ...
    var text = reformatText(quote.text, quote.reply_to, quote.mentions, null, quote.media);
    var minimedia = "";
    var mainmedia = "";
    ...
    var template = Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
      "class": "th-quote",
      children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
        "class": "th-quote-header",
        children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("img", {
          "class": "th-quote-header-profile",
          src: quote.profile_image
        }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
          "class": "th-quote-header-name",
          children: quote.name
        }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
          "class": "th-quote-header-username",
          children: ["@", quote.username]
        }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
          "class": "th-header-dot",
          children: "\xB7"
        }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
          "class": "th-quote-header-time",
          children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("a", {
            "class": "th-quote-header-time-link",
            href: getTweetUrl(quote),
            children: timeDiff
          })
        })]
      }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
        "class": "th-quote-reply",
        children: replyText
      }), Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
        "class": "th-quote-content",
        children: [minimedia, Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])("div", {
          "class": "th-quote-content-main",
          children: [Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
            "class": "th-text",
            children: text
          }), mainmedia]
    ...
    var _template = Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
      "class": "th-quote th-unavailable",
      children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
        "class": "th-quote-content",
        children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
          "class": "th-quote-content-main",
          children: Object(preact_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("div", {
            "class": "th-quote-content-main-text",
            children: "This Tweet is unavailable."
          })
        })
      })
    });
